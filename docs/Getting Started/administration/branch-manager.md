...
excerpt: Branch Managers manage Advisors within a branch, review client transfer requests, and configure approval settings that control whether transfers require sign-off before executing.
hidden: false
---
